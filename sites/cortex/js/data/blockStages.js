...
export const BLOCK_STAGES = [
	{
		title: 'RMSNorm',
		description: 'Hidden states are normalized before mixing, keeping activation scale stable as the stack gets deeper.',
	},
	{
	...
	{
		title: 'RMSNorm',
		description: 'A second normalization prepares the residual stream for the MLP.',
	},
	{
		title: 'MLP / FFN',
...
export const BLOCK_EXAMPLE = {
	flow: 'RMSNorm -> self-attention -> residual -> RMSNorm -> MLP/FFN -> residual',
	description: 'In each decoder block, hidden states are normalized, mixed via causal self-attention, added back through a residual connection, normalized again, passed through an MLP/FFN, and added through another residual path. This lets each token absorb context from earlier tokens.',
};
